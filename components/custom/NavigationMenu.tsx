...
export default function CNavigationMenu() {
    return (
                            ...
                            {overviewLinks.map((item) => (
                                <li key={item.href}>
                                    <Link href={item.href} className={linkCardClassName}>
                                        ...
                                        <p className="m-0 text-sm leading-5 text-muted-foreground">{item.description}</p>
                                    </Link>
                                </li>
                            ))}
                        </ul>
...
const linkCardClassName =
    ...
    'hover:bg-accent hover:text-accent-foreground focus-visible:relative focus-visible:outline focus-visible:outline-2 ' +
